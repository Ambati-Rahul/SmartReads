...
import { BookOpen, User, Sparkles, Library } from 'lucide-react';

export function UserDashboard() {
  const [activeTab, setActiveTab] = useState('catalog');

  const tabs = [
    { id: 'catalog', label: 'Book Catalog', icon: BookOpen, color: 'from-blue-500 to-cyan-500' },
    { id: 'mybooks', label: 'My Books', icon: User, color: 'from-purple-500 to-pink-500' }
  ];
          ...
          <div className="flex items-center space-x-3 mb-4">
            ...
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-400 flex items-center">
                ...
                Discover and manage your reading journey
              </p>
            </div>
          </div>
        </div>
